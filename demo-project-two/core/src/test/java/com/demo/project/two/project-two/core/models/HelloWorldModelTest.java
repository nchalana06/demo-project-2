 ...
 */
package com.demo.project.two.project-two.core.models;
...
import com.demo.project.two.project-two.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "demo-project-2/components/helloworld");
